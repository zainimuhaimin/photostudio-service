                      ...
                      <tr>
                        ...
                        <td class="p-2 align-middle bg-transparent dark:border-white/40 whitespace-nowrap shadow-transparent">
                          <div class="flex space-x-2 ">
                              ...
                              <button onclick="deletePelanggan(`Apakah Kamu Ingin Menghapus Data Ini ?`, <?=$val['id_pelanggan']?>)" id="delete-pelanggan" href="" class="text-red-500 hover:text-red-700">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<script>
  ...
  function deletePelanggan(message, idPelanggan) {
    console.log(`action delete untuk id ${idPelanggan} dengan pesan ${message}`);
    Swal.fire({
    title: message,
    icon: 'warning',
  ...
  function deletePelanggan(idPelanggan){
    $.ajax({
    url: `${baseUrl}pelanggan-delete/${idPelanggan}`,
    type: 'DELETE',
