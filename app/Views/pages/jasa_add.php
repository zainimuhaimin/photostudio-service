...
<div class="flex flex-wrap -mx-2">
        <div class="flex-none w-full max-w-full px-3">
            ...
            <div class="space-x-4 justify-between flex p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <h6 class="dark:text-white">Tambah Jasa</h6>
            </div>
            <div class="flex-auto px-0 pt-0 pb-2">
                <div class="p-6 overflow-x-auto">
                  <form role="form text-left" action="<?=base_url()?>jasa-save" method="POST">
                    <div class="mb-4">
                      <input autocomplete="off" name = "namajasa" required type="text" class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Nama Jasa" aria-label="namajasa" aria-describedby="email-addon" />
                    </div>
                    <div class="mb-4">
                      <input autocomplete="off" name="hargajasa" required type="text" class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Harga Jasa" aria-label="hargajasa" aria-describedby="email-addon" />
                    </div>
                    <div class="mb-4">
