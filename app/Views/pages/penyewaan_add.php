        ...
        <div class="p-6 overflow-x-auto w-1/2">
          <form role="form text-left" action="<?= base_url() ?>penyewaan-save" method="POST">
            ...
            <div class="mb-4">
              ...
              <input placeholder="Pilih jadwal ..." type="text" id="jadwal" name="jadwal" class="block appearance-none bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" />
            </div>
            <div class="mb-4">
